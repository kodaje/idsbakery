...
$result = mysql_query("SELECT name,quantity,price,define
FROM ingretbl");
      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            ...
            <li><a href="ingredients.php">Laporan</a></li>
...
<!--put bootstrap wizard here-->
 ...
 <div>
	<ul class='nav nav-wizard'>
				    <li class='active'><a href='' data-toggle="tab">1-Tentukan bahan</a></li>
				    <li><a href='settime.php' data-toggle="tab">2-Tentukan Masa</a></li>
				    <li><a href='' data-toggle="tab">3-Siap Pembuatan</a></li>
				  </ul>
 </div>
  ...
  while($row = mysql_fetch_array($result))  
  {
   ...
   if ($row[define]=="1"){
     ...
     echo "<td>".$row[quantity].$measurement."</td>";
