...
<?php echo "<img src = 'pictures/".$user01->getUserImage()."' height ='50' width = '50'/>";?>

    </a>
  </div>
</div>
            <li><a href="list.php">Lihat Pengguna</a></li>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          ...
          <h2 class="sub-header">Langkah membuat kek</h2>
	  1.Dapatkan bahan<br>
	  2.Masukkan bahan<br>
	  3.Bakar<br>
	  4.Packaging<br>
	  
	  <a href = "ingredients.php">Buat kek</a>
